...
from dscore.scorelib import __version__ as VERSION
from dscore.scorelib.argparse import ArgumentParser
...
from dscore.scorelib.six import iterkeys
from dscore.scorelib.uem import gen_uem, load_uem
from dscore.scorelib.utils import error, info, warn, xor
...
def main():
    ...
    parser = ArgumentParser(
        description="Score diarization from RTTM files.",
        add_help=True,
    ...
    parser.add_argument(
        ...
        type=float,
        metavar="FLOAT",
        help="collar size in seconds for DER computaton (default: %(default)s)",
    )
    parser.add_argument(
        "--ignore_overlaps",
        action="store_true",
    ...
    parser.add_argument(
        ...
        default=0.0,
        metavar="FLOAT",
        help="minimum reference speaker duration for JER (default: %(default)s)",
    )
    parser.add_argument(
        "--step",
        nargs=None,
    ...
    print_table(file_scores, global_scores, args.n_digits, args.table_format)
